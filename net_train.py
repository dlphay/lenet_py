...
def train_net(train_covnet, logfile, cycle, learn_rate, case_num = -1) :
    trainim_filepath = 'I:/Codes_vs2015/lenet_5/test_py2.7/train-images.idx3-ubyte'
    trainlabel_filepath = 'I:/Codes_vs2015/lenet_5/test_py2.7/train-labels.idx1-ubyte'
...
if __name__ == "__main__":
    ...
    log_timeflag = time.strftime("%Y.%m.%d_%H.%M.%S", time.localtime()) 
    train_covnet = CovNet()
    train_covnet.print_netweight('I:/Codes_vs2015/lenet_5/test_py2.7/log/origin_weight' + str(log_timeflag) + '.log')
    #logfile = open('../log/run_history.log', 'a')
    logfile = open('I:/Codes_vs2015/lenet_5/test_py2.7/log/nanerrortestcase.log', 'w')
    logfile.write("train_time:" + str(log_timeflag) + '\t')
    train_net(train_covnet, logfile, 1, [0.005, 0.001], 60000)
    train_covnet.print_netweight('I:/Codes_vs2015/lenet_5/test_py2.7/log/trained_weight' + str(log_timeflag) + '.log')
